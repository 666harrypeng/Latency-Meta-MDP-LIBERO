...
from latency_meta_mdp.data.tools.compute_sft_norm_stats import main
...
def test_real_patched_openpi_norm_stats_cover_every_l1_pilot_source(
    ...
    derived = Path("outputs/pilots/lerobot/panda-ball-formal-streaming-smoke-0ac4f2b/manifest.json")
    certification = Path(
    ...
    stats = json.loads((output / "norm_stats.json").read_text(encoding="utf-8"))["norm_stats"]

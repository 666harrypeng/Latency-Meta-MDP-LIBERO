...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("maximum_intentional_contact_penetration_m", 0.002001, "contact_penetration"),
        ...
        ("maximum_eef_jerk_mps3", 100.000001, "eef_jerk"),
        ("maximum_reference_tracking_error_m", 0.015001, "reference_tracking"),
        ("maximum_pregrasp_translation_error_m", 0.010001, "pregrasp_translation"),
        ("maximum_pregrasp_rotation_error_degrees", 2.000001, "pregrasp_rotation"),

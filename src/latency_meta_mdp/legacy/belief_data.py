...
class SharpTeacherBufferAdapter:
    ...
    def build(
        ...
        *,
        ...
        remaining_start, remaining_stop = self.temporal_contract.teacher_remaining_bounds(
            source_tick=source_tick,
            episode_action_count=episode.transition_count,
        )
        return SharpTeacherBuffer(
            ...
            remaining_actions=_readonly(episode.expert_actions[remaining_start:remaining_stop]),
        )
...
def load_belief_episode(episode_dir: Path) -> BeliefEpisodeView:
    ...
    supervision = BeliefSupervisionStream(
        ...
        object_velocity=_readonly(_require_shape(arrays, "object_velocity", (boundary_count, 6))),
...
def build_launch_history(
    *, episode: BeliefEpisodeView, index: BeliefSampleIndex
    ...
    return BeliefLaunchHistory(
        ...
        eef_orientation_matrix_world=_readonly(source.eef_orientation_matrix_world[selection]),
    )
...
def build_return_target(
    *, episode: BeliefEpisodeView, index: BeliefSampleIndex
    ...
    return BeliefReturnTarget(
        ...
        eef_orientation_matrix_world=_readonly(deployment.eef_orientation_matrix_world[tick]),
        ...
        commanded_motion_acceleration=_readonly(supervision.commanded_motion_acceleration[tick]),
        commanded_motion_segment_index=int(supervision.commanded_motion_segment_index[tick]),

...
from latency_meta_mdp.legacy.belief.flow.ghost_run import render_flow_belief_quality_run
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--ghost-config",
        type=Path,
        default=Path("configs/legacy/analysis/flow_belief_agentview_ghost_v1.yaml"),
    )

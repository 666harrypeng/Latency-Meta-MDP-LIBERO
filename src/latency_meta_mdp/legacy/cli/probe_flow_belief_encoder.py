...
from latency_meta_mdp.legacy.belief.flow.fresh_decoder_run import run_fresh_decoder_probe
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--probe-config",
        type=Path,
        default=Path("configs/legacy/analysis/dinov3_flow_belief_fresh_decoder_probe_v1.yaml"),
    )

"""Certify formal level-specific datasets through the pinned OpenPI loaders."""
...
from latency_meta_mdp.legacy.policy.sft_certification import LevelProbe, certify_lerobot_formal_run
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--profile",
        type=Path,
        default=Path("configs/legacy/policy/pi05_panda_ball_full_sft_h50_v2.yaml"),
    )
...
def main(
    ...
    *,
    ...
    if probe is None:
        ...
        from latency_meta_mdp.policy.openpi.training import probe_sft_pilot_level
    ...
    manifest = certify_lerobot_formal_run(

...
from latency_meta_mdp.runtime.latency_harness import LaunchContext
...
def write_latency_law_certification(
    *,
    ...
    if not np.isfinite(maximum_probability_error) or not 0.0 < maximum_probability_error < 1.0:

...
from latency_meta_mdp.runtime.action_chunk_parity import ActionChunkParityResult
from latency_meta_mdp.runtime.latency_parity import ParityLaneTrace
...
def write_action_chunk_parity_artifact(
    *,
    ...
    config_paths = {
        ...
        "client": root / "configs/runtime/client/sharp_return_time_h50_e25_v1.yaml",
        "temporal": root / "configs/contracts/temporal/h50_e25_d20_k6_v1.yaml",
    }
    ...
    try:
        ...
        _write_json(
            staging / "report.json",
            {
                ...
                "maximum_delay_ticks": (client_config.temporal_contract.maximum_delay_ticks),
                "bootstrap_simulation_time_before_us": (result.bootstrap.simulation_time_before_us),
                "bootstrap_simulation_time_after_us": (result.bootstrap.simulation_time_after_us),

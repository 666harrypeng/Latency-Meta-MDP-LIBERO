...
from latency_meta_mdp.data.lerobot_conversion import OPENPI_REVISION
    ...
    *,
    ...
    if reverse_check.returncode == 0:
        if _changed_paths(root) != _patch_paths(root, patch):
            raise ValueError("an already-patched checkout may contain only the integration patch")

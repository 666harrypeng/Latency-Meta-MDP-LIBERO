...
def _paths(root: Path, *, model_seed: int) -> dict[str, Path]:
    ...
    return {
        ...
        "training_config": root / "configs/training/action_conditioned_jepa/l3_admission.yaml",
        ...
        "nominal_law": root / "configs/latency/truncated_beta_8_65_400ms_v1.yaml",
        "law_family": root / "configs/latency/truncated_beta_family_8_65_400ms_v1.yaml",
    }


def _candidate_samplings(root: Path) -> tuple[Any, ...]:
    config_root = root / "configs/belief/action_conditioned_jepa"
    return tuple(

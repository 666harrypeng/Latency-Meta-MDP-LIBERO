    ...
    *,
    ...
    result = OfficialPredictorQualification(
        ...
        output_proprio_shape=(
            None if first_proprio is None else tuple(first_proprio.shape)
        ),
    ...
    *,
    ...
    if (
        ...
        or any(
            ...
            or qualification_by_name[name].checkpoint_size_bytes
            != mirror_by_name[name].size_bytes
...
def qualify_upstream_reference(
    *,
    ...
    return write_upstream_qualification_manifest(
        ...
        environment_lock_path=project_root.resolve()

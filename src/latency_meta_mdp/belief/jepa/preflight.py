...
from latency_meta_mdp.belief.jepa.model import DirectJepaPredictor
...
def main(argv: list[str] | None = None) -> int:
    ...
    source_files = [
        Path(__file__),
        config_path,
        *sorted((root / "src/latency_meta_mdp/belief/jepa").glob("*.py")),
        root / "src/latency_meta_mdp/belief/jepa/contracts.py",
    ]
    report = {

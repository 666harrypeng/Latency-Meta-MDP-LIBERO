...
def build_grouped_master_folds(
    *,
    ...
    development = tuple(tuple(sorted(ranked[offset::fold_count])) for offset in range(fold_count))
    return tuple(
        GroupedMasterFold(
        ...
        manifest = {
            ...
            **provenance,
            ...
            "certified_absorbing_extension_count": sum(
                value.boundary_disposition == "certified_absorbing_extension" for value in indices
            ),

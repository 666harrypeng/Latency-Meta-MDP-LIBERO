    ...
    *,
    ...
    if (
        ...
        or any(
            ...
            for value in requested_levels_raw
        )
    ...
    corpus = ControlBranchCorpus(
        ...
        expected_selection_slot_count=_require_manifest_integer(
            manifest, "selection_slot_count"
        ),
...
def load_verified_control_branch_corpus(manifest_path: Path) -> VerifiedControlBranchCorpus:
    ...
    selection_exclusion_count = _require_manifest_integer(

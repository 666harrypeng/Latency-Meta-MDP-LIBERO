...
from latency_meta_mdp.belief.conditional_return_flow.branch_contracts import BranchRollout
...
from latency_meta_mdp.motion import load_motion_config, motion_profile_from_mapping
        ...
        rows.append(
            np.concatenate(
                (
                    ...
                    np.asarray(
                        [
                            arrays["gripper_qpos"][tick, 0]
                            - arrays["gripper_qpos"][tick, 1],
                            arrays["gripper_qvel"][tick, 0]
                            - arrays["gripper_qvel"][tick, 1],
                        ]
                    ),

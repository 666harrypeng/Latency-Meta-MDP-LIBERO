...
class ActionContract:
    ...
    def from_mapping(cls, raw: dict[str, Any]) -> ActionContract:
        ...
        return cls(
            ...
            arm_input_high=_float_vector(
                raw["arm_input_high"], name="arm_input_high", length=6
            ),
            arm_output_low=_float_vector(
                raw["arm_output_low"], name="arm_output_low", length=6
            ),
            arm_output_high=_float_vector(
                raw["arm_output_high"], name="arm_output_high", length=6
            ),

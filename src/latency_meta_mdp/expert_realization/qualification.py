...
def qualify_actual_rollout(
    ...
    *,
    ...
    checks = (
        ...
        (
            report.unintended_pregrasp_ball_contacts
            <= gate.unintended_pregrasp_ball_contacts,
        ...
        (
            report.maximum_joint_velocity_fraction
            <= gate.joint_velocity_fraction_of_model_limit,
            "joint_velocity",
        ),
        ...
        (
            report.pre_handoff_saturation_fraction
            <= gate.pre_handoff_saturation_fraction,

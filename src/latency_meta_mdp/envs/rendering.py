    ...
    try:
        ...
        for camera_name in spec.policy_camera_names:
            ...
            cameras[camera_name] = {
                ...
                "world_position_at_capture": np.asarray(env.sim.data.cam_xpos[camera_id]).tolist(),
                "world_rotation_matrix_at_capture": np.asarray(env.sim.data.cam_xmat[camera_id])
                .reshape(3, 3)
                .tolist(),
            }
        manifest = {

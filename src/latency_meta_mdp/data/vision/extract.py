...
_PROVENANCE_PATHS = (
    ...
    "src/latency_meta_mdp/data/vision/dino.py",
    "src/latency_meta_mdp/data/vision/contracts.py",
    "src/latency_meta_mdp/data/vision/cache.py",
    "src/latency_meta_mdp/data/vision/extract.py",
    "src/latency_meta_mdp/data/vision/prepare.py",
    "src/latency_meta_mdp/data/collection/artifacts.py",
    "src/latency_meta_mdp/data/source/loader.py",
    "src/latency_meta_mdp/data/source/parquet.py",
)

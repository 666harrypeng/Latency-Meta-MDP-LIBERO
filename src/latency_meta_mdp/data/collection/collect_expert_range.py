"""Collect an explicit formal Panda-ball expert seed range."""
...
from latency_meta_mdp.data.bulk_collection import collect_expert_range  # noqa: E402


def _progress(index, total, result) -> None:
    print(
        f"[{index:04d}/{total:04d}] L{result.level} seed={result.seed} "

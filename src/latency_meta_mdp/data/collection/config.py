...
def load_structured_expert_config(path: Path) -> StructuredExpertConfig:
    ...
    return StructuredExpertConfig(
        ...
        soft_guide_radius_m=_require_float(raw["soft_guide_radius_m"], name="soft_guide_radius_m"),
        ...
        funnel_descent_ticks=_require_int(raw["funnel_descent_ticks"], name="funnel_descent_ticks"),
        ...
        handoff_window_ticks=_require_int(raw["handoff_window_ticks"], name="handoff_window_ticks"),
...
class CuroboPlannerConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            or self.runtime_config != "configs/data/expert_realization/curobo_runtime.yaml"
...
class FormalCorpusConfig:
    ...
    def __post_init__(self) -> None:
        ...
        expected_group = (
            "master_task_index" if self.schema_version == 1 else "logical_master_task_index"
        )
    ...
    def to_mapping(self) -> dict[str, Any]:
        return {
            ...
            ("split_unit" if self.schema_version == 1 else "group_unit"): self.group_unit,
        }
    ...
    def from_mapping(cls, mapping: Any) -> FormalCorpusConfig:
        ...
        unit_field = (
            "split_unit" if type(schema_version) is int and schema_version == 1 else "group_unit"
        )

...
EPISODE_SCHEMA_V2 = pa.schema([field for field in EPISODE_SCHEMA_V1_SPLIT if field.name != "split"])

EPISODE_SCHEMA = pa.schema(
    [field for field in EPISODE_SCHEMA_V2 if field.name != "realization_index"][:4]
    + [

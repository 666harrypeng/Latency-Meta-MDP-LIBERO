        ...
        rows.append(
            {
                ...
                "eef_orientation_matrix_world": _list(deployment.eef_orientation_matrix_world),
                ...
                "commanded_motion_position": _list(qualification.commanded_motion_position),
                "commanded_motion_velocity": _list(qualification.commanded_motion_velocity),
                "commanded_motion_acceleration": _list(qualification.commanded_motion_acceleration),
                "commanded_motion_segment_index": (qualification.commanded_motion_segment_index),
                ...
                "applied_reference_source_tick": (qualification.applied_reference_source_tick),

...
from latency_meta_mdp.data.recording import PhysicalEventKind, RecordProfile, SynchronizedEpisode
                ...
                rows.append(
                    {
                        ...
                        "handoff_time_us": _event_time(episode, PhysicalEventKind.HANDOFF),

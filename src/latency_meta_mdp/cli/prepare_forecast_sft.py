...
from latency_meta_mdp.forecast_delivery import (
...
def main():
    ...
    spec = load_vision_encoder_spec(root / "configs/vision/dinov3_vits16_lvd1689m_224_v1.yaml")
    ...
    command = [
        ...
        "-u",
        "-m",
        "latency_meta_mdp.cli.build_forecast_policy_cache",
        "--source-root",
        str(source),
